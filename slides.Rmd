...
- Labelled methods allow to pool samples before MS acquisition (up to
  ...
  variability and reducing missing data (see below).
...
### Other technologies: targetted proteomics

Selected reaction monitoring (SRMs) are pre-defined MS features that
the instrument will specifically scan for. This is the method to assay
a limited number of peptides/proteins in a high number of samples.
