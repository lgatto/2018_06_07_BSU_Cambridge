...
Take-home message: *In what ways to these summaries differ?*
...
1. Digestion of proteins into peptides - as will become clear later,
   the features we measure in 'proteomics' are peptides, **not**
   proteins.
...
(2010)](http://www.ncbi.nlm.nih.gov/pubmed/20622826).  See also
[Nesvizhskii and Aebersold
...
Really missing, of not detected (semi-stochastic nature of precursor
...
The advantage of these is that all data are recorded and has thus the
potential to collect and analyse all the data, this limiting the
...
[Wellcome Trust](https://wellcome.ac.uk/) (via Kathryn Lilley) and and
collaborators/contributors [Lisa
Breckels](https://github.com/lmsimp/), [Sebastian
